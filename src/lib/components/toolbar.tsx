    ...
    return (
        <nav className='flex flex-wrap items-center justify-center gap-2 py-2 pl-2 pr-1 lg:justify-start'>
            ...
            <Menu as='div' className='relative z-10 inline-block text-left'>
                {({ open }) => (
                    <>
                        <Menu.Button className='inline-flex w-full items-center justify-center gap-1 rounded-md bg-brand-600 px-2.5 py-1.5 text-sm font-medium text-white md:px-4 md:py-2'>
                            <span>Create</span>
                            <Plus
                                size={20}
